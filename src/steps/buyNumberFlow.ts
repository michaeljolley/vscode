...
export abstract class BuyNumberFlow {
  ...
  private static async selectCountry(
    input: MultiStepInput,
    state: Partial<BuyNumberState>,
  ) {
  ...
  private static async selectNumberType(
    input: MultiStepInput,
    state: Partial<BuyNumberState>,
  ) {
    const result = await input.showQuickPick({
  ...
  private static async selectNumber(
    input: MultiStepInput,
    state: Partial<BuyNumberState>,
  ) {
